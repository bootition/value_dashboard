...
const RESULT_ROWS = [
  { stock_code: '600519', name: '贵州茅台', pe_ttm: 10, roe: 0.3, debt_ratio: 0.2, _entry_explanation: 'pe_ttm > 0 (实际: 10.0000)' },
  { stock_code: '000858', name: '五粮液', pe_ttm: 8, roe: 0.25, debt_ratio: 0.3, _entry_explanation: 'pe_ttm > 0 (实际: 8.0000)' },
]
