...
| `reports/` | 报告 | 审计/验收/审查等事件型快照（05–49） | 仅 29/40/43/44/45/46/47/48/49 ✅；其余为发现/修复事实被后续取代 |
...
- `reports/49_DESKTOP_UI_PARITY_AND_DATA_STATUS_FIX_2026-08-04.md` — 桌面界面样稿同构与数据状态修复报告
