...
| `reports/` | 报告 | 审计/验收/审查等事件型快照（05–50） | 仅 29/40/43/44/45/46/47/48/50 ✅；其余为发现/修复事实被后续取代 |
...
- `reports/50_FINAL_SCREENING_UI_AND_AUTO_UPDATE_RECOVERY_2026-08-05.md` — 当前筛选 UI、状态一致性与自动更新恢复依据
